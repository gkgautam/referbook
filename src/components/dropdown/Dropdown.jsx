...
{
  content.options.map((item)=><a key={item} href="#" className="hover:text-white hover:bg-gradient-to-r from-[#7A4297] via-[#B1268C] to-[#DD242F] no-underline block text-black py-3 px-4">{item}</a>)
}
